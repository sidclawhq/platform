    ...
    <header className="flex items-center justify-between border-b border-[#2A2A2E] px-6 py-3">
      <div className="flex items-center gap-4">
        ...
        <span className="rounded bg-[#3B82F6]/10 px-2 py-0.5 text-xs font-medium text-[#3B82F6]">
          Interactive Demo — Clinical AI
        </span>
      </div>
      <div className="flex items-center gap-4">
        <a href="https://docs.sidclaw.com" target="_blank" rel="noopener noreferrer" className="text-xs text-[#A1A1AA] hover:text-[#E4E4E7]">
          Docs
        </a>
        <a href="https://github.com/sidclawhq/platform" target="_blank" rel="noopener noreferrer" className="text-xs text-[#A1A1AA] hover:text-[#E4E4E7]">
          GitHub
        </a>

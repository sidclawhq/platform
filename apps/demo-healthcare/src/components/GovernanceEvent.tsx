...
const EVENT_STYLES: Record<string, { color: string; icon: string }> = {
  trace_initiated:            { color: '#3B82F6', icon: '\u25B6' },
  identity_resolved:          { color: '#3B82F6', icon: '\u2713' },
  delegation_resolved:        { color: '#3B82F6', icon: '\u2713' },
  policy_evaluated:           { color: '#A78BFA', icon: '\u2696' },
  sensitive_operation_detected:{ color: '#F59E0B', icon: '\u26A0' },
  approval_requested:         { color: '#F59E0B', icon: '\u29D7' },
  approval_granted:           { color: '#22C55E', icon: '\u2713' },
  approval_denied:            { color: '#EF4444', icon: '\u2717' },
  approval_expired:           { color: '#71717A', icon: '\u29D6' },
  operation_allowed:          { color: '#22C55E', icon: '\u2192' },
  ...
  trace_closed:               { color: '#71717A', icon: '\u2014' },
};

...
export function ConditionsList() {
  return (
    <div className="rounded-lg border border-[#2A2A2E] bg-[#111113] p-4">
      <h4 className="mb-3 text-sm font-medium uppercase tracking-wider text-[#71717A]">Active Conditions</h4>
          ...
          <div key={condition.icd10} className="flex items-start gap-2">
            ...
            <div>
              <div className="text-base text-[#E4E4E7]">
                {condition.name}{' '}
                <span className="font-mono text-sm text-[#71717A]">({condition.icd10})</span>
              </div>

...
|---|---|---|---|---|
| `apiKey` | `string` | Yes | -- | Your SidClaw API key (e.g., `ai_...`) |
...
- **[NemoClaw](/docs/integrations/nemoclaw)** — `governNemoClawTools()` for NVIDIA NemoClaw sandboxes
- **[MCP](/docs/integrations/mcp)** — `GovernanceMCPServer` proxy for any MCP server
- **[LangChain](/docs/integrations/langchain)** — `governTools()` wraps LangChain tool arrays
- **[OpenAI Agents](/docs/integrations/openai-agents)** — `governOpenAITool()` for function tools
- **[All integrations](/docs/integrations/mcp)** — Complete list

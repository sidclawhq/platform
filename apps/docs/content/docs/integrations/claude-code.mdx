...
SidClaw is listed on the [official MCP Registry](https://registry.modelcontextprotocol.io) — search for "sidclaw" in Claude Desktop or Cursor's server picker to find it.

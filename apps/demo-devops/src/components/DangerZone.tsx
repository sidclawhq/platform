...
export function DangerZone({ actionStates, onAction }: DangerZoneProps) {
  ...
  return (
    <div className="rounded-lg border border-[#EF4444]/20 bg-[#111113] p-4">
      <div className="mb-1 text-xs font-medium text-[#EF4444]">Danger Zone</div>
      <p className="text-[10px] text-[#71717A] mb-3">These actions are blocked by governance policy</p>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        >
          <div className="text-xs text-[#EF4444]">🗑 Delete load-test-march</div>
          <div className="text-[10px] text-[#71717A] mt-0.5">Namespace • 6 services, 30 pods</div>
        </button>
        <button
        ...
        >
          <div className="text-xs text-[#EF4444]">🔑 Rotate payment-processor secrets</div>
          <div className="text-[10px] text-[#71717A] mt-0.5">Credential rotation • production</div>
        </button>
      </div>
    </div>
  );
